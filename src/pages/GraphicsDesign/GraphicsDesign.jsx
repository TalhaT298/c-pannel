    ...
    <>
     <Helmet>
      ...
      <div>
        ...
        <p className="text-center font-thin text-xl pt-4 text-white px-4 lg:px-0 md:px-0">
          <p>
        ...
        <div className="flex items-center justify-center  w-full h-[80vh] ">
          <div className="flex flex-col items-center my-20 mt-40 lg:mt-0 md:mt-0 text-white space-y-8">
            {/* featured div  */}
        ...
        {/* ---------------------------------4th phase finish----------------------------*/}
        {/* ---------------------------------5th phase start----------------------------*/}
        <div className="py-12 pt-16 lg:pt-0 md:pt-0">
        <Marquee className="pt-16" direction="right" speed={50}>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">Typography</p>
          ...
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">Logo Design</p>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">
            Packaging Design
          </p>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">Web Design</p>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">Icon Design</p>
        </Marquee>
        <Marquee className="my-5" direction="left" speed={50}>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">
            Motion Graphics
          </p>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">Animation</p>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">3D Modeling</p>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">
            Graphic Elements
          </p>
          <p className="text-xl md:text-4xl font-extrabold font-serif px-4">
