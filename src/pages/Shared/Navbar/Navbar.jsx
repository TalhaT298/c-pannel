    ...
    <div className=''>
      <nav className="flex items-center justify-between bg-[#000000]  py-4 text-white ">
        <div className="scale-100 cursor-pointer rounded-2xl px-3 py-2 text-xl font-semibold text-white transition-all duration-200 ">
          <Link to="/"><img src={logo} className='w-48 h-16' alt="" /></Link>
        </div>
        <ul className="hidden items-center justify-between gap-10 md:flex">
          ...
          <Link to="/career">
          <li className="group flex  cursor-pointer flex-col">
            Career<span className="mt-[2px] h-[3px]  w-[0px] rounded-full bg-white transition-all duration-300 group-hover:w-full"></span>
          </li>
          </Link>
          <li className="group flex  cursor-pointer flex-col">
          <Link to="/sched">
